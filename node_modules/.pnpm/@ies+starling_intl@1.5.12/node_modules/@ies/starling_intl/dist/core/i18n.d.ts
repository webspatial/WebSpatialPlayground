...
import { KeyRenderReporterOptions, KeyRenderReporter } from '@ies/intl-key-render-report-plugin';
import { Options as FormatOptions } from 'intl-messageformat';
...
export interface IntlInitOptions extends Omit<InitOptions, 'missingInterpolationHandler'> {
    ...
    icuConfig?: ICUConfig;
    keyRenderReportConfig?: KeyRenderReporterOptions;
    inContext?: boolean;
    reactKeyAdder?: (nodes: unknown[]) => unknown;
...
export default class I18next {
    ...
    getDir(lng: string): "ltr" | "rtl";
    t<TResult extends TFunctionResult = string, TKeys extends TFunctionKeys = string, TInterpolationMap extends object = StringMap>(keys: TKeys | TKeys[], options?: TOptions<TInterpolationMap> | string, fallbackText?: string): TResult;
    addResourceBundle(lng: string, ns: string, resources: any, deep?: boolean, overwrite?: boolean): i18n;
    cloneInstance(options?: InitOptions, callback?: Callback): I18next;
}
