(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var IES_INTL_ICU_PLUGIN = /** @class */function () {
    ...
    IES_INTL_ICU_PLUGIN.prototype.parse = function (res, options, lng, ns, key, info) {
      ...
      var memKey = this.options.memorize && lng + "." + ns + "." + key.replace(/\./g, '###');
      ...
      try {
        if (!fc) {
          ...
          if (this.options.memorize && (this.options.memoizeFallback || !info || hadSuccessfulLookup)) {
  ...
  var __objRest = function __objRest(source, exclude) {
    ...
    if (source != null && __getOwnPropSymbols) {
      var _iterator = _createForOfIteratorHelper(__getOwnPropSymbols(source)),
        _step;
      try {
  ...
  function uniqArray(a) {
    ...
    var uniqueSet = /* @__PURE__ */new Set([].concat(_toConsumableArray(a), _toConsumableArray(b)));
    var result = [];
  ...
  function isFallback(translator, key) {
    ...
    try {
      var locale = translator == null ? void 0 : translator.language;
      var transLocale = locale && ((_b = (_a = translator == null ? void 0 : translator.resourceStore) == null ? void 0 : _a.data) == null ? void 0 : _b[locale]);
      var ns = (_c = translator == null ? void 0 : translator.options) == null ? void 0 : _c.defaultNS.toString();
      var transValue = transLocale && ns && ((_d = transLocale == null ? void 0 : transLocale[ns]) == null ? void 0 : _d[key]);
      if (!transValue) {
        hitFallback = true;
      }
    } catch (error) {}
  ...
  var KeyRenderReporter = /*#__PURE__*/function () {
    function KeyRenderReporter(pluginOptions) {
      _classCallCheck(this, KeyRenderReporter);
    ...
    return _createClass(KeyRenderReporter, [{
      key: "clear",
      ...
      key: "_reportTea",
      value: function _reportTea(store) {
        return __async(this, null, function* () {
          var _this = this;
          var events = Object.entries(store || this.keyRenderCache || {}).map(function (_ref) {
            var _ref2 = _slicedToArray(_ref, 2),
              cachedKey = _ref2[0],
              _ref2$ = _ref2[1],
              keyList = _ref2$.keyList,
              _ref2$$extraInfo = _ref2$.extraInfo,
              extraInfo = _ref2$$extraInfo === void 0 ? {} : _ref2$$extraInfo;
            _this.logger("cachedKey-info=", cachedKey, extraInfo);
            var _cachedKey$split = cachedKey.split(DIVID_STR),
              _cachedKey$split2 = _slicedToArray(_cachedKey$split, 4),
              caller = _cachedKey$split2[0],
              projectId = _cachedKey$split2[1],
              namespaceId = _cachedKey$split2[2],
              hitFallback = _cachedKey$split2[3];
            var p = {
              projectId: projectId,
          ...
          var eventArray = splitArray(events);
          var r = yield Promise.all(eventArray.map(function (ets) {
            var protocol = /^https:\/\//.test(_this.TEAChannelDomain || "") ? "" : "https://";
            return fetch("".concat(protocol).concat(_this.TEAChannelDomain, "/").concat(_this.TEAChannelVersion).concat(_this.TEAChannelVersion === "v2" ? "/event" : "", "/list"), {
              method: "POST",
              headers: {
              ...
              body: JSON.stringify([{
                user: {
                  user_unique_id: window.location.host
                },
                header: {
                  app_id: /zijieapi|bytedance|byted|dongchedi|bd\.feishu|volceapplog|czgts/.test(_this.TEAChannelDomain || "") ? 4797 : 3297
                },
                events: ets,
                verbose: 1
              }])
      ...
      value: function getStore() {
        return __async(this, null, function* () {
          var record = (yield get$1(storeKey)["catch"](function (e) {
            return void 0;
          })) || {
            store: {},
            firstSec: 0
      ...
      value: function print() {
        return __async(this, null, function* () {
          var r = (yield this.getStore()) || {};
          var store = Object.entries(r.store).reduce(function (prev, cur) {
            var _cur = _slicedToArray(cur, 2),
              k = _cur[0],
              v = _cur[1];
            var _k$split = k.split(DIVID_STR),
              _k$split2 = _slicedToArray(_k$split, 4),
              caller = _k$split2[0],
              projectId = _k$split2[1],
              namespaceId = _k$split2[2],
              hitFallback = _k$split2[3];
            prev["".concat(projectId, "|").concat(namespaceId, "|").concat(caller).concat(hitFallback ? "|" + hitFallback : "")] = v;
            return prev;
          }, {});
      ...
      key: "_reportKeyRenderRecord",
      value: function _reportKeyRenderRecord() {
        return __async(this, null, function* () {
          ...
          var r = yield this.getStore();
          this.logger("进入_reportKeyRenderRecord,r=", r, this.TEAChannelDomain, this.strategy);
          if ((r == null ? void 0 : r.store) && _typeof(r == null ? void 0 : r.store) === "object" && Object.keys(r == null ? void 0 : r.store).length && (r == null ? void 0 : r.firstSec)) {
      ...
      key: "storeKeyRenderRecord",
      value: function storeKeyRenderRecord(keyRenderCache) {
        return __async(this, null, function* () {
          var _this2 = this;
          clearTimeout(this.timer);
          this.timer = window.setTimeout(function () {
            return __async(_this2, null, function* () {
              var record = yield this.getStore();
              var store = Object.entries(keyRenderCache).reduce(function (prev, cur) {
                var _cur2 = _slicedToArray(cur, 2),
                  cachedKey = _cur2[0],
                  _cur2$ = _cur2[1],
                  keyList = _cur2$.keyList,
                  extraInfo = _cur2$.extraInfo;
      ...
      key: "recordKeyRender",
      value: function recordKeyRender(_ref3) {
        var key = _ref3.key,
          processArgs = _ref3.processArgs;
        var _a;
        if (typeof window === "undefined" || typeof fetch === "undefined" || typeof indexedDB === "undefined") {
          return;
        }
        var projectId = this.projectId,
          ...
          TEAChannelDomain = this.TEAChannelDomain;
        this.logger("原始check =", {
          projectId: projectId,
          namespaceId: namespaceId,
        ...
        if (!(projectId && namespaceId && TEAChannelDomain)) {
          var o = ((_a = processArgs == null ? void 0 : processArgs.translator) == null ? void 0 : _a.options) || {};
          if (o.projectId) projectId = o.projectId;
          if (o.namespaceId) namespaceId = o.namespaceId;
          if (o.TEAChannelDomain) TEAChannelDomain = o.TEAChannelDomain;
        }
        if (TEAChannelDomain && key) {
          if (!(projectId && namespaceId) && this.getProjectAndNs) {
            try {
              var res = this.getProjectAndNs(processArgs);
          ...
          if (projectId && namespaceId) {
            ...
            if (this.reportFallback) {
              if (typeof this.reportFallback === "boolean") {
                ...
                try {
                  var tmpHitFallback = this.reportFallback(processArgs == null ? void 0 : processArgs.translator, key.toString());
                  if (typeof tmpHitFallback === "boolean" || _typeof(tmpHitFallback) === "object") {
                    hitFallback = tmpHitFallback;
                  }
                } catch (error) {}
              }
            }
            var renderedKey = key.toString();
            if (Array.isArray(key) && key.length > 1) {
              renderedKey = key.join("|");
            }
            var caller = (window.location.host + window.location.pathname).replace(/\/\d+/g, "/_").replace(/\w{32}/, "____");
            var cachedKey = "".concat(caller).concat(DIVID_STR).concat(projectId).concat(DIVID_STR).concat(namespaceId);
            if (hitFallback) {
              cachedKey = "".concat(cachedKey).concat(DIVID_STR, "hitFallback");
            }
            ...
            var _o = this.keyRenderCache[cachedKey];
            this.logger("hitFallback,o=", _o);
            if (hitFallback) {
              if (_o.extraInfo) {
                _o.extraInfo.hitFallback = true;
              } else {
                _o.extraInfo = {
                  hitFallback: true
                };
              }
              if (_typeof(hitFallback) === "object" && hitFallback.extraInfo && _typeof(hitFallback.extraInfo) === "object" && Object.values(hitFallback.extraInfo).every(function (v) {
                return typeof v === "string";
              })) {
                try {
                  _o.extraInfo = Object.assign(_o.extraInfo, hitFallback.extraInfo);
                } catch (error) {}
              }
            }
  ...
  function registerKeyRenderReportPlugin(pluginOptions) {
    var krr = new KeyRenderReporter(pluginOptions || {});
    var _a = pluginOptions || {},
      getProjectAndNs = _a.getProjectAndNs,
      logger = _a.logger,
      simpleOptions = __objRest(_a, ["getProjectAndNs", "logger"]);
  ...
  ***************************************************************************** */
  ...
  var defaultConfig = {
    ...
    // 如果使用了 Language Detector，i18next 底层 lng 的权重是大于插件的
    fallbackLng: ['en-US'],
    inContext: true
  };
  // 默认开启ICU插值解析
  var defaultPluginMap = {
    icu: IES_INTL_ICU_PLUGIN,
    inContext: index,
    renderReport: registerKeyRenderReportPlugin
  };
  var defaultPlugins = [defaultPluginMap.icu, defaultPluginMap.inContext, defaultPluginMap.renderReport];
  /**
   * I18n内核
   * 安全校验
   */
  var I18next = /*#__PURE__*/function () {
    function I18next(config, plugins) {
      ...
      _defineProperty(this, "_waitingToAddResourceBundle", []);
      if (config !== null && config !== void 0 && config.copiedI18nextInstance) {
        // just clone instance
      ...
      this.KRRList = KRRList;
    }
    return _createClass(I18next, [{
      key: "_handlePlugins",
      value: function _handlePlugins(plugins) {
        var _this$config, _this$config$icuConfi;
        var processedPlugins = [].concat(defaultPlugins);
        // 关闭ICU插值解析
        if (((_this$config = this.config) === null || _this$config === void 0 ? void 0 : (_this$config$icuConfi = _this$config.icuConfig) === null || _this$config$icuConfi === void 0 ? void 0 : _this$config$icuConfi.open) === false) {
          processedPlugins = processedPlugins.filter(function (p) {
            return p.name !== pluginName;
          });
        }
        this.plugins = Array.isArray(plugins) ? plugins.concat(processedPlugins) : processedPlugins;
      }
    }, {
      key: "_handleConfigs",
      ...
      value: function createInstance() {
        ...
        return new Promise(function (resolve, reject) {
          ...
          if (typeof window !== 'undefined' && !window.CocosEngine && _this.config.inContext) {
            _this.config.postProcess = [].concat(['inContext', 'keyRender'], _this.config.postProcess || []);
            window['__STARLING_DEVTOOLS_I18N'] = _this.instance;
          }
          _this.plugins.map(function (p) {
            if (p.name === 'IES_INTL_ICU_PLUGIN') {
              p.staticInit(_this.instance);
            }
            if (p === defaultPluginMap.renderReport) {
              _this.instance.use(p(_this.config.keyRenderReportConfig));
              // registerKeyRenderReportPlugin
            } else {
              _this.instance.use(p);
            }
          });
          var config = _this.config;
          _this.config.formats = Object.assign({}, _this.config.formats, defaultFormats);
          var formatLng = formatLang(config.lng, _this.plugins.filter(isTypes(types.LAMGUAGE_TRANSFORMER)));
          _this.instance.init(Object.assign({}, config, {
            lng: formatLng,
            i18nFormat: Object.assign({}, config.i18nFormat || {}, {
            ...
            try {
              // 把等待添加的东西都加进去
              var _iterator = _createForOfIteratorHelper(_this._waitingToAddResourceBundle),
                _step;
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  var _this$instance;
                  var item = _step.value;
                  (_this$instance = _this.instance).addResourceBundle.apply(_this$instance, _toConsumableArray(item));
                }
              } catch (err) {
                _iterator.e(err);
              } finally {
              ...
              _this._waitingToAddResourceBundle = [];
              // eslint-disable-next-line no-empty
            } catch (err) {}
            if (!err) {
              _this._updateLanguages();
              resolve({
                t: t,
                err: err
              });
      ...
      value: function changeLanguageWithPromise(lng) {
        var _this3 = this;
        return new Promise(function (resolve, reject) {
          _this3.config.lng = lng;
          _this3.instance.changeLanguage(lng, function (err, t) {
            if (err) {
              reject({
                err: err,
                t: t
      ...
      key: "t",
      value: function t(keys, options, fallbackText) {
        ...
        var result = this.instance.t(keys, fallbackText, opt);
        if (Array.isArray(result) && this.config.reactKeyAdder) {
          return this.config.reactKeyAdder(result);
        }
        return result;
      }
    }, {
      ...
      value: function cloneInstance(options, callback) {
        var nextI18nextInstance = this.instance.cloneInstance(options, callback);
        var nextCore = new I18next({
          copiedI18nextInstance: nextI18nextInstance
        });
        nextCore.t = this.t.bind(nextCore);
        nextCore.config = this.config;
        nextCore.plugins = this.plugins;
        nextCore.languages = this.languages;
        nextCore.init = nextI18nextInstance.isInitialized || Boolean(this.init);
        nextCore.userLng = this.userLng;
        nextI18nextInstance.on('initialized', function () {
          nextCore.init = true;
        });
        return nextCore;
      }
  ...
  var Intl$1 = /*#__PURE__*/function () {
    function Intl(opts) {
      var _opts$i18nInstance;
      _classCallCheck(this, Intl);
      this.plugins = [];
      this.i18nInstance = (_opts$i18nInstance = opts === null || opts === void 0 ? void 0 : opts.i18nInstance) !== null && _opts$i18nInstance !== void 0 ? _opts$i18nInstance : new I18next();
    }
    return _createClass(Intl, [{
      key: "use",
      ...
      value: function init(config, initCallback) {
        try {
          var _this = this;
          // ignore warning
          _this.ignoreWarning = config.ignoreWarning;
          _this.i18nInstance._handleConfigs(config);
          _this.i18nInstance._handlePlugins(_this.plugins);
          return _await(_catch(function () {
            return _await(_this.i18nInstance.createInstance(), function (_ref) {
              var err = _ref.err,
                t = _ref.t;
              // 接入 Intl thirdParty 类型 Plugin
              var intlThirdPartyArray = _this.plugins.filter(function (p) {
              ...
              return _await(promiseQueue(intlThirdPartyArray.map(_async(function (intlThirdParty) {
                ...
                return _awaitIgnored(initFunction(_this));
              }))), function () {
      ...
      value: function t(keys, options, fallbackText) {
        ...
        if (!that.ignoreWarning && (!that.i18nInstance || !that.i18nInstance.init)) {
          try {
            var msg = "The instance has not been initialized: i18n.t('".concat(keys, "'").concat(options ? ',' + JSON.stringify(options) : '', ");");
            logger.error(msg);
          } catch (error) {}
      ...
      key: "cloneInstance",
      value: function cloneInstance(options) {
        var cloneInstance = this.i18nInstance.cloneInstance(options);
        var cloneIntl = new Intl({
          i18nInstance: cloneInstance
        });
        // todo:: 先考虑 clone t 一个函数，因为 intl-react-plugin 会覆盖
        // todo:: 是否需要全量 copy？包括所有的函数
        cloneIntl.t = this.t.bind(cloneIntl);
        cloneIntl.plugins = this.plugins;
        cloneIntl.ignoreWarning = this.ignoreWarning;
        return cloneIntl;
      }
    }]);
  }();
  IntlInstance = new Intl$1();

  var I18n$1 = IntlInstance;
  I18n$1.t = I18n$1.t.bind(I18n$1);
