...
exports.ON_PARSE_ERROR_STRATEGY = void 0;
...
})(exports.ON_PARSE_ERROR_STRATEGY || (exports.ON_PARSE_ERROR_STRATEGY = {}));
var DEFAULT_ON_PARSE_ERROR_STRATEGY = exports.ON_PARSE_ERROR_STRATEGY.replaceAnyway;
var DEFAULT_OPTIONS = {
    memorize: false,
    memoizeFallback: false,
    bindI18n: false,
    bindI18nStore: false,
    onParseError: exports.ON_PARSE_ERROR_STRATEGY.replaceAnyway
};
var IES_INTL_ICU_PLUGIN = /** @class */ (function () {
    ...
    IES_INTL_ICU_PLUGIN.prototype.init = function (i18next, options) {
        ...
        if (i18next) {
            var _a = this.options, bindI18n = _a.bindI18n, bindI18nStore = _a.bindI18nStore, memorize = _a.memorize;
            i18next.IntlMessageFormat = IntlMessageFormat__default["default"];
            this.IntlMessageFormat = IntlMessageFormat__default["default"];
            i18next.ICU = this;
            if (memorize) {
                if (bindI18n) {
    ...
    IES_INTL_ICU_PLUGIN.prototype.addLocaleData = function (data) {
        ...
        locales.forEach(function (localeData) {
            if (localeData && localeData.locale) {
                IntlMessageFormat__default["default"].__addLocaleData(localeData);
    ...
    IES_INTL_ICU_PLUGIN.prototype.checkMissingInterpolation = function (icuAST, messageText, options, lng, key) {
        ...
        for (var _i = 0, icuAST_1 = icuAST; _i < icuAST_1.length; _i++) {
            ...
            switch (this.options.onParseError) {
                ...
                case exports.ON_PARSE_ERROR_STRATEGY.keepRaw:
                    throw new Error();
                // 插值参数丢失策略：替换丢失的这个文案为 Key 值
                case exports.ON_PARSE_ERROR_STRATEGY.replaceAnyway:
...
Object.defineProperty(exports, 'IntlMessageFormat', {
    enumerable: true,
    get: function () { return IntlMessageFormat__default["default"]; }
});
exports.DEFAULT_ON_PARSE_ERROR_STRATEGY = DEFAULT_ON_PARSE_ERROR_STRATEGY;
exports.DEFAULT_OPTIONS = DEFAULT_OPTIONS;
exports["default"] = IES_INTL_ICU_PLUGIN;
