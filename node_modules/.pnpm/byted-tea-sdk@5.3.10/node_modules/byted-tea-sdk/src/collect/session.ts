...
export default class Session {
  ...
  collect: any
  disableSessionTimeCheck: boolean
  apply(collect: any, config: any) {
    ...
    this.disableSessionTimeCheck = config.disable_session_check
    if (this.disableSession) return
    this.setSessionId()
    this.collect.on(Types.SessionReset, (sessionId?: string) => {
      this.resetSessionId(sessionId)
    })
  ...
  setSessionId() {
    ...
    this.storage.setItem(this.sessionKey, sessionCache)
    if (!this.disableSessionTimeCheck) {
  ...
  resetSessionId(_sessionId?: string) {
    var sessionCache = {
