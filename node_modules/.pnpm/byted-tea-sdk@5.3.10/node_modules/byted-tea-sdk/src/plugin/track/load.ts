...
import { VISUAL_EDITOR_RANGERS, HOT_PIC_URL, SDK_VERSION, allowOrigins } from '../../collect/constant'
...
export default function readyToLoadEditor(autoTrackInstance, options) {
  ...
  // let isPrivate = options.channel_domain
  // let _editorUrl = ''
  ...
  //     if (app_id && app_id !== options.app_id) return;
  //     /**@@PRIVITY
  //     if (isPrivate) {
