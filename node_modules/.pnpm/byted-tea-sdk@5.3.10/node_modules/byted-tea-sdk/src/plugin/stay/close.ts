...
export default class Close {
  ...
  constructor(collect: any, config: any) {
    ...
    this.config = config
    this.maxDuration = config.maxDuration || config.max_duration || 24 * 60 * 60 * 1000
