export interface IInitParam {
  ...
  request_type?: string;
  disable_session_check?: boolean;
  ab_user_mode?: string;
  custom_request_header?: EventParams
  batch_event?: boolean
  disable_spa_query?: boolean
  enable_logsetting?: boolean
  enable_device_id?: boolean
  disable_debug?: boolean
  need_zip?: boolean
  enable_logsetting_params?: boolean;
  enable_logsetting_header_custom?: boolean;
  devtool_url?: string;
  allow_visual_origin?: string[];
  enable_observe?: boolean;
  transport?: SdkTransport;
  disable_cache_refer?: boolean;
}
...
export declare enum SdkHook {
  ...
  SessionResetInner = 'session-reset-inner',
  Event = 'event',
  Events = 'events',
  EventNow = 'event-now',
  ...
  SDKInnerError = 'sdk-inner-error',
  SDKRunTimeError = 'sdk-run-time-error',

  LogSetting = 'log-setting',
  LogSettingReady = 'log-setting-ready',
  ...
  SessionRecordStart = 'session-record-start',
  SessionRecordPause = 'session-record-pause',
  SessionRecordEnd = 'session-record-end',
  SessionRecordReport = 'session-record-report',

  DestoryInstance = 'destory-instance',

  VisualCollectReady = 'visual-collect-ready',
  VisualApiReady = 'visual-api-ready',
  VisualApiUpdate = 'visual-api-update',
  ...
  XhrBeforeSend = 'xhr-before-send',

  XhrCurrendSend = 'xhr-current-send',
...
interface SdkConstructor {
  new(name: string): Sdk;
  instances: Array<Sdk>;
  usePlugin: (plugin: PluginConstructor, pluginName?: string, options?: any) => void;
}
interface Sdk {
  ...
  beaconEvent(event: string, params?: EventParams): void;
  event(
    events:
  ...
  setPageViewParams(params: Record<string, any>): void;
  ...
  enableTransPort(): void;
  disableTransPort(): void;
