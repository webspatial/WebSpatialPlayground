...
export declare class CodeInspectorComponent extends LitElement {
    ...
    ip: string;
    sendImage: string;
    curentSelectedHTMLElement: HTMLElement | undefined;
    position: {
        top: number;
        right: number;
        bottom: number;
    ...
    elementInfoSenderInputRef: HTMLTextAreaElement;
    aimeSendButtonRef: HTMLButtonElement;
    ...
    getOldWayFilePath: (target: HTMLElement) => {
        name: string;
        path: string;
        line: number;
        column: number;
    ...
    findTargetElement: (e: MouseEvent | TouchEvent) => HTMLElement | undefined;
    renderHoverPosition: (targetNode: HTMLElement) => void;
