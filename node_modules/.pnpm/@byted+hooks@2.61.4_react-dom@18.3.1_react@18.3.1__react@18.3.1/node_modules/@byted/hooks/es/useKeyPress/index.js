...
var modifierMap = new Map(zip(modifierAliases, modifiers));
...
function matchKey(event, key) {
  ...
  return aliasKey && aliasKey.includes(event.key) || aliasKeyCode && aliasKeyCode.includes(event.keyCode) || ((_event$key = event.key) === null || _event$key === void 0 ? void 0 : _event$key.toUpperCase()) === (key === null || key === void 0 ? void 0 : key.toUpperCase()) || event.altKey && event.keyCode === (key === null || key === void 0 ? void 0 : key.toUpperCase().charCodeAt(0));
}
/**
 * 判断按键是否激活
...
export function matchCombo(event, keyFilter) {
