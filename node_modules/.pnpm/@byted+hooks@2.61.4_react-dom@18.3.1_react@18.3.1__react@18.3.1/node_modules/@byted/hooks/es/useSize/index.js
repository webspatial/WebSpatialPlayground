...
var useSize = function useSize(el) {
  ...
  if (typeof options === 'string') {
    ...
    if (options.throttleOption) {
      throttleOption = options.throttleOption;
    }
  }
  ...
  var observeCallback = useCallback(function (entries) {
  ...
  var _useThrottleFn = useThrottleFn(observeCallback, throttle, [observeCallback], throttleOption),
  ...
  useLayoutEffect(function () {
    ...
    var ros = new ResizeObserver(observeCallbackThrottle);
