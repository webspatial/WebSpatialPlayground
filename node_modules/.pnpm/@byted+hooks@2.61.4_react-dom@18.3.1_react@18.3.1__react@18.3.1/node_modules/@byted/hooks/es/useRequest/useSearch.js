...
import useRequest from './useBaseRequest';
...
function useSearch(requestFn) {
  ...
  var defaultValue = options.defaultValue,
      ...
      _options$debounceThro = options.debounceThrottleOptions,
      debounceThrottleOptions = _options$debounceThro === void 0 ? {
    type: 'debounce',
    interval: 300
  } : _options$debounceThro,
      restOptions = _objectWithoutProperties(options, ["defaultValue", "refreshDeps", "debounceThrottleOptions"]);
  ...
  var _useRequest = useRequest(requestFn, _objectSpread(_objectSpread({
    defaultParams: [defaultValue]
  }, restOptions), {}, {
    debounceThrottleOptions: debounceThrottleOptions,
    auto: false
  })),
      run = _useRequest.run,
