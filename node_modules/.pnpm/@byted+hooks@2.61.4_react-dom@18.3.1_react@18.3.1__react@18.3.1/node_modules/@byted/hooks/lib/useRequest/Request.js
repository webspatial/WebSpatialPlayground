...
var Request = /*#__PURE__*/function () {
  ...
  function Request(requestFn, options, onChangeState, initState) {
    ...
    this.count = 0;
    this.unmountedFlag = new _CBoolean.default();
    this.that = this;
    ...
    if (debounceInterval !== undefined) {
      ...
      if (type === 'debounce') {
        this.debounceFn = (0, _lodash.default)(this._run.bind(this.that), interval, {
          leading: leading,
          trailing: trailing
        });
      } else if (type === 'throttle') {
        this.throttleFn = (0, _lodash2.default)(this._run.bind(this.that), interval, {
          leading: leading,
          trailing: trailing
        });
      }
