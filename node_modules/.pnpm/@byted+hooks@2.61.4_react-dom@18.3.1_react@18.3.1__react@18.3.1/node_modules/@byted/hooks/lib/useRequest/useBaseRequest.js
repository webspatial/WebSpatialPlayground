...
var _CBoolean = _interopRequireDefault(require("./CBoolean"));
...
var useBaseRequest = function useBaseRequest(requestFn) {
  ...
  var cacheStoreTypeRef = (0, _react.useRef)(cacheStoreType);
  ...
  var getNewRequestByCache = function getNewRequestByCache() {
    ...
    if (cacheKeyRef.current) {
      var _ref = (0, _cache.getCache)(cacheKeyRef.current, cacheStoreTypeRef.current) || {},
          data = _ref.data,
  ...
  if (requests[currentRequestKey.current]) {
    ...
    returnValue = {
      ...
      data: initData,
      error: undefined,
      unmountedFlag: new _CBoolean.default(),
      params: [],
