...
var _starling_client = _interopRequireDefault(require("@ies/starling_client"));
...
var useStarling = function useStarling(starlingConfig) {
  ...
  var trans = (0, _react.useMemo)(function () {
    var getTexts = function getTexts(key, format) {
      if (!format) return texts[key];
      return new _intlMessageformat.default(texts[key], lang).format(format);
    };
  ...
  (0, _react.useEffect)(function () {
    ...
    var starling = new _starling_client.default(_objectSpread(_objectSpread({
      // @ts-ignore
