...
function useMultiSelect(items) {
  ...
  (0, _react.useEffect)(function () {
    var availableKeys = availableItems.map(getSelectedKey);

    if (selected.some(function (selectedItem) {
      return !availableKeys.includes(getSelectedKey(selectedItem));
    })) {
      selectedSet.clear();
      setSelected([]);
    }
  ...
  var noneSelected = selectedSet.size === 0;
  var allSelected = !noneSelected && selectedSet.size === availableItems.length;
